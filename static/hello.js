...
/*
* udacity quiz1
* Generate the message with timing
*/
function greetwithtime(){
	var name = document.getElementById("name_field").value;
	var time = document.getElementById("greetwithtime").value;
	var request = gapi.client.helloworldendpoints.greetperiod({"name":name,"timeperiod":time});
	request.execute(sayHelloCallback)
}
